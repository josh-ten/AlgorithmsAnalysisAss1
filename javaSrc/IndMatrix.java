 ...
 *
 * @author Mia Turner, Joshua Tencic, 2018.
 */
public class IndMatrix<T extends Object> implements FriendshipGraph<T> {
    ...
    public void addVertex(T vertLabel) {
        ...
        // Set the value of existing vertices to 0
    ...
    /*
     * recursively checks each next level of the graph until either it checks
     * all neighbours or finds a connection
     */
